    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-gray-600 mb-6">
          Your order has been placed successfully. Get ready for the fastest delivery!
        </p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6 border-l-4 border-green-600">
          ...
          <p className="text-2xl font-bold text-green-600 font-mono mb-4">{orderId}</p>

          <div className="space-y-3 text-left border-t border-gray-200 pt-4">
            <div className="flex justify-between">
              <span className="text-gray-600">Delivery Time:</span>
              <span className="font-semibold text-gray-800">8-10 minutes</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="space-y-3 text-left">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Order at your door</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <p className="text-gray-500 text-sm">Redirecting to home in 10 seconds...</p>
        </div>
      </div>
    </div>
  );
